...
while True:
   sabor = input('Entre com o sabor desejado (PS/PD): ') # Pergunta ao usuário o sabor dejesado
   if sabor in ('PS', 'PD'):
      tamanho = input('Entre com o tamanho desejado (P/M/G): ') # Pergunta ao usuário o tamanho dejesado
      if tamanho in ('P', 'M', 'G'): # Verifica tamanho pedido
         if sabor == 'PD': # Verifica sabor pedido
            if tamanho == 'P':
               total += 34
               print('Você pedi uma Pizza Doce no tamanho P: R$34,00')
               print('')
            elif tamanho == 'M':
               total += 48
               print('Você pedi uma Pizza Doce no tamanho M: R$48,00')
               print('')
            elif tamanho == 'G':
               total += 66
               print('Você pedi uma Pizza Doce no tamanho G: R$66,00')
               print('')
         elif sabor == 'PS':
            if tamanho == 'P':
               total += 30
               print('Você pedi uma Pizza Salgada no tamanho P: R$30,00')
               print('')
            elif tamanho == 'M':
               total += 45
               print('Você pedi uma Pizza Salgada no tamanho M: R$45,00')
               print('')
            elif tamanho == 'G':
               total += 60
               print('Você pedi uma Pizza Salgada no tamanho G: R$60,00')
               print('')
